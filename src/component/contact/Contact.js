  ...
  return (
    <div className='bg-slate-800'>
        <div className='flex sm:flex-row flex-col-reverse justify-center  sm:gap-20 gap-12'>
           <form className='sm:w-2/5  shadow-2xl bg-slate-800 text-white mt-16 mb-32'>
             ...
             <div className='ml-72 mb-12 font-medium text-white w-40 py-2 text-center rounded-lg tracking-wider bg-indigo-900 hover:bg-indigo-600 focus:right-1 focus:ring-indigo-900 duration-500'>
